...
import irs2014.pressure.PressureIndicatorCalculator;
import irs2014.pressure.PressureIndicatorRunner;
...
public class MainIterativeComponentRobot extends IterativeComponentRobot {
	...
	{//This is just testing the task set in Auto Input Map
		...
		b.add(new PressureIndicatorCalculator());
		...
		b.add(new PressureIndicatorRunner());
