 ...
 */
public class AnalogSensorGyro extends SensorBase implements PIDSource, ISensor {

    static final int kOversampleBits = 10;
    static final int kAverageBits = 0;
    static final double kSamplesPerSecond = 50.0;
    static final double kCalibrationSampleTime = 5.0;
    //this value is specific to the AnalogSensor gyro
    static final double kDefaultVoltsPerDegreePerSecond = 0.0125;
     ...
     */
    public AnalogSensorGyro(int slot, int channel) {
     ...
     * @param channel The analog channel the gyro is connected to.
     */
    public AnalogSensorGyro(int channel) {
     ...
     */
    public AnalogSensorGyro(AnalogChannel channel) {
        m_analog = channel;
        if (m_analog == null) {
